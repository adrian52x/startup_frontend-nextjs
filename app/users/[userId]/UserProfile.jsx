    ...
    return (
        ...
        isSmallScreen ? (
            <section className='mt-10'>
                ...
                <div className='max-w-[400px] h-[250px] bg-gray-200'>A</div>
                <div className='max-w-[400px] mt-8 bg-gray-200 '>C</div>
                <div className='max-w-[400px] mt-8 bg-gray-200'>B</div>
                </div>
            </section>
          ) : (
            <section className='mt-10 mx-6'>
                <div className='max-w-[1280px] mx-auto grid grid-cols-[350px,1fr] gap-x-[70px]'>
                    <div className='grid grid-flow-row gap-y-[32px]'>
                        <div className='w-[350px] h-[235px] bg-gray-200'>A</div>
                        <div className='w-[350px] bg-gray-200'>B <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /><br /> <br /> <br /> <br /> <br /> sfdsf</div>
                    </div>
                    <div className=' md:min-w-[450px] md:max-w-[740px] bg-gray-200'>C <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /> sfdsf</div>
                </div>
            </section>
          )
